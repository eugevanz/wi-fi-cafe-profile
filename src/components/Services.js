    ...
    <div {...props} ref={ref}>
      <div className="flex flex-col gap-8 md:w-1/2">
        ...
        <p className="max-w-md text-center text-gray-500 md:text-left pb-10">
          ...
          large venue visitors. This includes investing in state-of-the-art WIFI
          infrastructure and technology to handle the high density and bandwidth
          demands of a large space such as a mall. By providing clear and
          easy-to-follow instructions for accessing the WIFI network, we
          dedicate a significant amount of our time to user experience.
          Additionally, we offer customer support and technical assistance to
          help address any issues or concerns that may arise during the
          experience. By focusing on providing a high-quality WIFI experience,
          mall visitors can fully engage with their favorite stores and share
      ...
      <div className="flex flex-col gap-8 md:w-1/2">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-gray-500 text-center md:text-left">
            We provide a seamless and personalized experience for mall visitors.
            This includes implementing advanced technology and infrastructure to
            support high-performance internet across the entire mall.
          </p>
        </div>
        <div className="flex flex-col gap-2">
          <div className="rounded-full bg-orange-200 md:bg-transparent">
        ...
        <div className="flex flex-col gap-2">
          <div className="rounded-full bg-orange-200 md:bg-transparent">
            <div className="flex items-center gap-3 p-1 pr-4">
              ...
              <p className="text-base font-medium text-gray-900">New Revenue</p>
            </div>
          </div>
          <p className="text-gray-500 text-center md:text-left">
